...
/**
 * Identical validation rules to PatientRegistrationRequest.
 * patientId, createdAt, createdBy, and version are NOT part of the update payload
 * (version is passed via the If-Match header for optimistic locking).
 */
