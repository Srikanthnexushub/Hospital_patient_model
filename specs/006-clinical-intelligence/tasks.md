...
- [X] T001 Verify baseline tests pass by running `mvn test` and `mvn verify -Pfailsafe` in `backend/` — all 108 existing tests must pass before any new code is written
